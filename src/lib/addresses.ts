...
export const POOL_SRC_FACTORY_ADDRESS: Record<ChainId, `0x${string}`> = {
  [opSepolia.id]: process.env.OP_SEPOLIA_SRC_FACTORY_ADDRESS as `0x${string}`,
...
export const POOL_DST_FACTORY_ADDRESS: Record<ChainId, `0x${string}`> = {
  [opSepolia.id]: process.env.OP_SEPOLIA_DST_FACTORY_ADDRESS as `0x${string}`,
...
export const ORACLE_ADDRESS: Record<ChainId, `0x${string}`> = {
  [opSepolia.id]: process.env.OP_SEPOLIA_ORACLE_ADDRESS as `0x${string}`,
